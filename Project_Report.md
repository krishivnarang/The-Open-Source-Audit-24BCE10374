...
# Author: Aishwary Jaiswal | Course: Open Source Software
# Software: Git
...
# Redirecting errors to /dev/null to keep output clean
...
# Specific check for Git's global config
...
# While read loop to process line by line securely
...
# Using 'read' to capture user input interactively
read -p "1. Name one open-source tool you use every day: " TOOL
read -p "2. In one word, what does 'freedom' mean to you? " FREEDOM
read -p "3. Name one thing you would build and share freely: " BUILD

# Capture current date and construct dynamic filename
DATE=$(date '+%d %B %Y')
